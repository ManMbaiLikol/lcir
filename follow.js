...
(function () {
  ...
  var CHANNELS = [
    { key: 'whatsapp', label: 'Suivre sur WhatsApp', href: 'https://whatsapp.com/channel/0029VbDwnnc4o7qNIpvFJq0k' },
    { key: 'telegram', label: 'Rejoindre sur Telegram', href: '' }
  ];
  ...
  function mount(container) {
    ...
    container.innerHTML =
      '<div class="follow-label">SUIVRE LE LABORATOIRE</div>' +
      '<div class="follow-sub">Recevez chaque nouvelle publication directement sur votre messagerie.</div>';
